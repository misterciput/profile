      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <ul id="top-menu" class="nav navbar-nav main-nav menu-scroll">
            ...
            <li class="active"><a href="event-all.html">VIEW ALL event </a></li>
                    ...
                    <?php foreach($upcoming as $key => $event){?>
                      ...
                      <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <a href="event-all.html" class="button button-default" data-text="View All" type="submit"><span>View All</span></a>
