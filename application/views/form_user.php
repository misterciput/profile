<form class="col s12" action="<?=base_url()?>user/do_insert" method="post" enctype="multipart/form-data">
  <div class="row">
   ...
   <div class="row">
    <div class="input-field col s12">
      <input placeholder="" id="judul" type="password" class="validate" name="password">
