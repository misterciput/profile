...
<html lang="en">
  ...
  <header id="header">
    <div class="header-inner">
      ...
      <div class="header-overlay">
        ...
        <h2 class="header-slide">DIGITAL SIGNATURE
          <span>SECURE</span>
          <span>EFFECTIVE</span>
          <span>EFFICIENT</span>
          WAY TO SIGN!</h2>
    ...
    <nav class="navbar navbar-default main-navbar" role="navigation">  
      <div class="container">
        <div class="navbar-header">
          ...
          <!-- LOGO -->                                               
           <a class="navbar-brand logo" href="index.html"><img src="assets/images/logo1.png" alt="logo"></a>                      
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav main-nav menu-scroll">
            <!-- <li class="active"><a href="index.html">Home</a></li> -->
            <li><a href="#about">Apa itu Digital Signature?</a></li> 
            <li><a href="#manfaat">Manfaat eSignature</a></li>                    
  ...
  <!-- End flow req section -->

  <!-- Start from news section -->
  <section id="news">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="from-blog-area">
            ...
            <div class="from-blog-content">
              <div class="row">
              <?php
                foreach ($headline_news as $key => $hn) {
              ?>
                <div class="col-md-4">
                  <article class="single-from-blog">
                    ...
                    <div class="blog-footer">
                      ...
                      <a href="#" class="button button-default" data-text="MORE"><span>READ MORE</span></a>-->
                    </div>
                  </article>
                </div>
              <?php
          ...
          <div class="portfolio-area">
            ...
            <div class="portfolio-content">
               ...
               <div id="mixit-container" class="portfolio-container">
                <?php
                  foreach ($all_event as $key => $ae) {
                  if(date('Y-m-d') <= strtotime($ae->date) AND date('m',strtotime($ae->date)) == date('m')){
                    $tab = 'upcoming';
                  }else{
                    $tab = 'all';
                  }
               ?>
                <div class="single-portfolio mix <?=$tab?>">
                   <div class="single-item">
                     <img src="<?=base_url()?>assets/img/<?=$ae->pict?>" alt="img">
                     <div class="single-item-content">
                        ...
                        <div class="portfolio-title">
                          <h4><?=$ae->title?></h4>
                          <span><?=date('d F Y', strtotime($ae->date))?></span>
                        </div>
                     </div>
                   </div>
                 </div>
